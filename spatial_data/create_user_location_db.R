...
# - Census Geocodes ("census_geocodes.xlsx") https://www.census.gov/geographies/reference-files/2018/demo/popest/2018-fips.html
# - State abbreviations ("state_abbr.csv") https://www.ssa.gov/international/coc-docs/states.html
# - Federal place to ZIP crosswalk ("city2zipcode.csv") http://federalgovernmentzipcodes.us/index.html
# - HUD ZIP code to county crosswalk ("zip2county_hud.xlsx"): https://www.huduser.gov/portal/datasets/usps_crosswalk.html# - Census
# - Census county boundary shapefiles ("cb_2019_us_county_20m"): https://www.census.gov/geographies/mapping-files/time-series/geo/cartographic-boundary.html
# NOT included in the repository:
# - Raw user data ("tweets.db"): Sourced from user SQLite database
# - County Health Rankings: ("chr2020.csv"): Sourced from https://www.countyhealthrankings.org/resources/2020-chr-national-statistics
# - COVID hospitalization data ("hosp.csv"): Sourced from https://beta.healthdata.gov/Hospital/COVID-19-Reported-Patient-Impact-and-Hospital-Capa/anag-cw7u
...
# categorize remaining places (for diagnostics)
